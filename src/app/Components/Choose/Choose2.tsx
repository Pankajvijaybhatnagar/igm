            ...
            <div className="col-xl-7 col-lg-6">
              <div className="choose-us-content">
                <div className="section-title">
                  <span className="sub-title wow fadeInUp">Why Attend IGM</span>
                ...
                <div className="choose-us-area">
                  ...
                  <div className="choose-us-items wow fadeInUp" data-wow-delay=".3s">
                    ...
                    <div className="content">
                      ...
                      <p>
                        Listen to enlightening discourses on the Bhagavad Gita from eminent spiritual leaders from India and around the world, deepening your understanding of eternal wisdom.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="choose-us-items wow fadeInUp" data-wow-delay=".5s">
                    ...
                    <div className="content">
                      <h4>Rich Cultural Programs and Performances</h4>
                      <p>
                        Witness spectacular cultural performances including classical dance, devotional music, theatrical presentations of Mahabharata, and traditional folk art from across India.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="choose-us-items wow fadeInUp" data-wow-delay=".7s">
                    ...
                    <div className="content">
                      <h4>Visit Sacred Sites and Participate in Rituals</h4>
                      <p>
                        Experience the divine atmosphere of Kurukshetra&apos;s holy sites including Brahma Sarovar and Jyotisar, and participate in sacred rituals and ceremonies during the festival.
                      </p>
                    </div>
                  </div>
                </div>
